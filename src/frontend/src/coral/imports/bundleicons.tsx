...
export const TaskListSquareLtr = bundleIcon(
  TaskListSquareLtrFilled,
  TaskListSquareLtrRegular
);
export const Mic = bundleIcon(MicFilled, MicRegular);
export const PersonVoice = bundleIcon(PersonVoiceFilled, PersonVoiceRegular);

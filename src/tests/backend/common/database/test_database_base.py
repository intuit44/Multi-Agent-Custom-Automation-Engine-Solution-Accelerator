...
class TestDatabaseBaseAbstractClass:
    ...
    def test_abstract_method_count(self):
        ...
        expected_methods = {
            ...
            "get_plan",
            "get_all_plans",
            "get_all_plans_by_team_id",
            "get_all_plans_by_team_id_status",
            "add_step",
            "update_step",
            "get_steps_by_plan",
            "get_step",
...
class TestDatabaseBaseMethodSignatures:
    ...
    def test_team_agent_methods(self):
        ...
        team_agent_methods = ["add_team_agent", "delete_team_agent", "get_team_agent"]
    ...
    def test_method_type_annotations(self):
        ...
        for method_name in methods_to_check:
            ...
            assert len(annotations) > 0, (
                f"Method {method_name} missing type annotations"
            )
...
class TestConcreteImplementation:
    ...
    async def test_context_manager_implementation(self):
        ...
        class MinimalDatabase(DatabaseBase):
            ...
            async def get_all_plans_by_team_id_status(self, team_id, status):
                return []
...
class TestDatabaseBaseAbstractMethodCoverage:
    ...
    async def test_abstract_methods_callable_via_super(self):
        ...
        class TestDatabase(DatabaseBase):
            ...
            async def get_all_plans_by_team_id_status(self, user_id, team_id, status):
                return await super().get_all_plans_by_team_id_status(
